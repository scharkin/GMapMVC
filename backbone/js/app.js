$(function () {
  ...
  var MapView = Backbone.View.extend({
    ...
    initialize: function (places) {
      ...
      this.map = new google.maps.Map(document.getElementById('place-map'), mapOptions);
      var that = this;
      // sort place list by city
      var collection = new Places(new Places(places).sortBy(function(c) {return c.get('city')}));
